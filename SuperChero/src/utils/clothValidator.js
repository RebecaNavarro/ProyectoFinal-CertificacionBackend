...
export function validateClothBody(body) {
  ...
  if (!body.name || typeof body.name !== "string" || body.name.trim() === "") {
    errors.push("El campo 'name' es obligatorio y debe ser una cadena no vacía.");
  }
  if (!body.description || typeof body.description !== "string") {
    errors.push("El campo 'description' es obligatorio y debe ser una cadena.");
  }
  if (!body.category) {
  ...
  if (!body.size || !SIZES.includes(body.size)) {
    errors.push(`El campo 'size' debe ser uno de: ${SIZES.join(", ")}.`);
  }
  ...
  if (body.color !== undefined && typeof body.color !== "string") {
    errors.push("El campo 'color' debe ser una cadena.");
  }
  if (body.imageURL !== undefined && typeof body.imageURL !== "string") {
    errors.push("El campo 'imageURL' debe ser una cadena.");
  }
